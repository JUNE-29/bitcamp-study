...
CREATE TABLE t_students (
  ...
  accout          VARCHAR(20)  NOT NULL COMMENT '통장번호', -- 통장번호
  bank            VARCHAR(40)  NOT NULL COMMENT '은행명' -- 은행명
)
COMMENT '학생';
...
CREATE TABLE t_managers (
  menagers_no INTEGER      NOT NULL COMMENT '회원번호', -- 회원번호
  photo       VARCHAR(255) NULL     COMMENT '사진', -- 사진
...
CREATE TABLE t_lesson_rooms (
  ...
  centre         VARCHAR(40) NOT NULL COMMENT '센터', -- 센터
