...
public class Servlet01 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    // 테스트
    // - http://localhost:9999/java-web/ex05/test01.html 실행
    //
    ...
    // ServletRequest엔 getMethod() 메서드가 없다. 그래서 위에서 HttpServletRequest로 형변환 하여 사용.
    ...
    // 매번 형변환하여 사용하면 번거롭다.
    // 그래서 GenericServlet을 상속받아 MyHttpServlet(도우미클래스)를 사용 -> Servlet02
    //
