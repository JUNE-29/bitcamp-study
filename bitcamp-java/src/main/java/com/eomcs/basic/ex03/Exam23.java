...
public class Exam23 {
  public static void main(String[] args) {
    ...
    System.out.println(-2147483648); // -2**31 = 2의31승 : 4바이트 최소 음수 값
    System.out.println(2147483647); // 2**31 -1 = 4바이트로 표현 할 수 있는 최대 값

    //System.out.println(-2147483649); // 4바이트 메모리 크기 초과
    //System.out.println(2147483648); // 4바이트 메모리 크기 초과 

    //8바이트(64bit) 정수 리터럴
    // 숫자 뒤에 접미사 L,1을 붙인다. 소문자 l은 잘 안쓰인다.
    ...
    System.out.println(100L); // 8바이트 정수 리터럴 , 4바이트 정수 리터럴과 다르다. 같은 100이 아님
