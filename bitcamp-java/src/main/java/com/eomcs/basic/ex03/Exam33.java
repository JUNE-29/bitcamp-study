...
public class Exam33 {
  public static void main(String[] args) {
    ...
    // => 4바이트 메모리에 저장할 수 있는 부도소수점은
    //    소수점의 위치에 상관없이 숫자의 개수가 7개 이면 거의 정상적으로 저장하고 꺼낼 수 있다.
    //    이렇게 정상적으로 넣고 꺼낼 수 있는 부동소수점의 숫자개수를 "유효자릿수"라고 부른다.
    // => 주의! 
    ...
    //    변경하는데, 이 규칙에서 일부 부동소수점은 2진수로 정확히 변경되지 못하는 문제가 있다.
    // 
