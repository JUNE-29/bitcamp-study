...
public class Exam7 {
  public static void main(String[] args) {
    ...
    System.out.println("Hello,\nworld!"); // 줄바꿈 문자 \ n -> new line
    System.out.println("Hello,\rabc"); // 커서(cursor)를 처음으로 돌리는 문자
    // 커서란? 문자를 출력할 위치를 가리키는 것. \r -> return

    System.out.println("Hello,\b\b\bworld!"); // 커서를 뒤로 한 칸 이동시키는 문자
    System.out.println("Hello,\tworld!"); // 탭 공간을 추가 시키는 문자
    System.out.println("Hello,\fworld!"); // formfeed 추가 시키는 문자
    System.out.println("Hello,\"w\"orld!"); // "" 문자를 추가 시키는 문자
