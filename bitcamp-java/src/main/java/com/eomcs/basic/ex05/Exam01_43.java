...
public class Exam01_43 {
  public static void main(String[] args) {
    ...
    //float과 float의 연산결과는 float이기 때문이다.
    
    System.out.println(r1);
    // 기대 값: => 987.6543 + 1.111111 = 988.7654(11)
    // 결과 값: => 988.7654
    // 출력과 옳지 않게 이유?
    ...
    // 기대 값: => 988.765411
    // 결과 값: => 988.765380859375
    // 출력과 옳지 않게 이유?
    // => float과 float의 연산 결과는 float이다.
    // => double 변수에 저장 전에 이미 float 값이 되면서 일부 값이 왜곡되었다.
    
    // 그런데 r1 변수와 달리 뒤에 이상한 숫자가 많이 붙는 이유는 무엇인가?
    // => IEEE 754의 이진수 변환 문제때문이다.
    // => 4바이트 float 부동소수점을 8바이트 double 부동소수점에 변수에 저장할 때
    //   왜곡된 값이 들어 갈 수 있다.
