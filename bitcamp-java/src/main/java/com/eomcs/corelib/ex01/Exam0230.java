...
public class Exam0230 {
  public static void main(String[] args) {
    ...
    Integer obj3 = 100; // Integer.valueOf(100) 와 같다.
    Integer obj4 = 100; // Integer.valueOf(100) 와 같다.
    System.out.println(obj3 == obj4);
    // 설명: 
    // => 정수 리터럴을 이용하여 auto-boxing으로 객체를 생성할 경우 constants pool(상수풀)에 생성된다.
    // => 같은 값을 가지는 Integer 객체가 여러 개 존재해야 할 필요가 없다.
    // => 그래서 가능한 이 방법을 사용해야 한다.
    // => 자바에서도 메모리 절약을 위해 이 방법을 사용하도록 유도하기 위해
    //    Wrapper 클래스의 생성자를 Deprecated로 선언 하였다.
