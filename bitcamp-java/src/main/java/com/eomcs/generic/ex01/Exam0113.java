...
public class Exam0113 {
  ...
  static class Box<T> {
    ...
    // N - number
    // V - value
    // 여러 개의 타입 파라미터를 선언해야 할 경우 보통 두 번쨰 파라미터부터 다음 알파벳을 사용한다.
    // S, U, V 등
    // 예) class Box<T,S,U,V> {..}
  ...
  public static void main(String[] args) {
    ...
    // 메서드를 사용할 때 그 타입 전용 클래스 인 것처럼 쓰면 된다.
    ...
    // Member 넣기로 했는데 String으로 쓰면 오류 난다.
    
    // 결론:
    // => 제네릭 문법을 사용하면 Object 타입을 사용하는 것 보다 편리하다
    // => 각 타입 별로 클래스를  따로 정의한 듯한  효과가 있다.
    //
