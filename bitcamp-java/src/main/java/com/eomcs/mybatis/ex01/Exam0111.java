// Data Persistence Framework 도입 - 좀 더 쉽게 Mybatis설정 파일의 InputStream 얻는 방법
...
public class Exam0111 {
  ...
  public static void main(String[] args) throws Exception {
    // 1. mybatis 설정 파일을 읽을 InpusStream 도구를 준비한다.
    ...
    SqlSessionFactoryBuilder factioryBuilder = new SqlSessionFactoryBuilder();

    SqlSessionFactory factory = factioryBuilder.build(mybatisConfigInputStream);
