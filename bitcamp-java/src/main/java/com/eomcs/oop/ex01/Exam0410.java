...
public class Exam0410 {
  public static void main(String[] args) {
    ...
    // 기본적으로 Score.class 파일을 찾을때 같은 패키지 안에서 찾는다. 클래스파일들을...
    Score s1 = new Score();
    s1.name = "홍길동";
...
// 방법1) Score.class 파일을 갖고 있다면 그 파일이 있는 위치를 알려줘라. (컴파일된것을 갖고있다면)
//   > javac -encoding UTF-8 -d bin -classpath bin/main src/main/java/com/eomcs/oop/ex01/Exam0410.java
// 
// 방법2) Score 클래스의 소스 파일이 있다면 소스 파일의 위치를 알려줘라.  
//   > javac -encoding UTF-8 -d bin/main -sourcepath src/main/java src/main/java/com/eomcs/oop/
//           ex01/Exam0410.java
//          
// 언제 이렇게 해야 하는가?
