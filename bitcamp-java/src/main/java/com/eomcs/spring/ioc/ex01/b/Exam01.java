...
public class Exam01 {
  public static void main(String[] args) {
    ...
    // => 단, URL 형식으로 지정해야 한다.
    // => 예) file:// 설정파일경로
    // => URL 형식에서는 파일 시스템을 가리킬 때 'file://' 접두어를 붙인다.
    //
    ApplicationContext iocContainer2 = new FileSystemXmlApplicationContext(
        "file://\\Users\\doll9\\git\\bitcamp-study\\bitcamp-java\\src\\main\\java\\com\\eomcs\\spring\\ioc\\ex01\\b\\application-context.xml");
