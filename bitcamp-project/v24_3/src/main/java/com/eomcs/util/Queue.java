...
public class Queue<E> extends LinkedList<E> implements Cloneable {
  ...
  public E poll() {
    ...
    // 꺼내면 바로 지워야 하니까 remove 호출. 
    // 값을 조회하는게 아니라서 get 호출이 아니다.
  }
...
/*
  ...
  */
  ...
  public Iterator<E> iterator() {
    // this에 인스턴스 주소가 넘어온다. 
    // inner class의 생성자를 호출 할 때는 바깥 클래스의 인스턴스 주소를 파라미터로 넘기지 말고
    // 앞에서 넘겨라.
