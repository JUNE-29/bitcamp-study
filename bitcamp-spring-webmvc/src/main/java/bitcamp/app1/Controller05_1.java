...
public class Controller05_1 {
  ...
  // 테스트:
  // http://localhost:9999/java-spring-webmvc/app1/c05_1/h2
  ...
  // 테스트:
  // http://localhost:9999/java-spring-webmvc/app1/c05_1/h3
  @GetMapping("h3")
  @ResponseBody
  ...
  // 테스트:
  // http://localhost:9999/java-spring-webmvc/app1/c05_1/h4
  @GetMapping("h4")
  ...
  // 테스트:
  // http://localhost:9999/java-spring-webmvc/app1/c05_1/h5
  ...
  // 테스트:
  // http://localhost:9999/java-spring-webmvc/app1/c05_1/h6
  @GetMapping("h6")
  public HttpEntity<String> handler6(HttpServletResponse response) {
    ...
    HttpEntity<String> entity =
        new HttpEntity<>("<html><body><h1>abc가각간<h1></body></html>", headers);

    return entity;
  }

  // 테스트:
  // http://localhost:9999/java-spring-webmvc/app1/c05_1/h7
  @GetMapping("h7")
